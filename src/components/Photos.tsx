...
function Placeholder({ label }: { label: string }) {
  return (
    <div className="relative w-full h-full bg-ink-elevated-2 rounded-xl overflow-hidden
      flex flex-col items-center justify-center gap-2 group">
      {/* Camera icon */}
      <div className="w-10 h-10 rounded-lg bg-ink-elevated flex items-center justify-center
      ...
      <span className="text-[11px] font-medium text-white/30 text-center px-4 leading-tight">
        {label}
      </span>
      <span className="text-[10px] text-white/20">Photo coming soon</span>
    </div>
  )
}
...
export default function Photos() {
  ...
  return (
    <section id="photos" className="py-24 bg-ink">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-12">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-neon-violet mb-3">Gallery</p>
            <h2 className="text-3xl md:text-4xl font-brand font-black text-white tracking-tight">See the work.</h2>
          </div>
        ...
        <div className="mb-8 rounded-2xl border border-ink-border overflow-hidden flex flex-col md:flex-row">
          {/* Finger Rule image — brand accent */}
          <div className="md:w-1/3 bg-ink-elevated-2 flex items-center justify-center p-10">
            <img
              src={fingerRule}
          ...
          <div className="md:w-2/3 p-8 flex flex-col justify-center bg-ink-elevated">
            <p className="text-xs font-semibold uppercase tracking-[0.15em] text-neon-violet mb-2">Featured</p>
        ...
        <p className="mt-6 text-center text-xs text-white/40">
          ...
          <a href="/nightlife#contact" className="text-neon-violet hover:underline font-medium">
            Request placement
          </a>{' '}
