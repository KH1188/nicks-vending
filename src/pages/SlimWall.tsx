...
function Carousel() {
  ...
  return (
        ...
        >
          {IMAGES.map((img, i) => (
            <div key={i} style={{ width: `${100 / IMAGES.length}%` }} className="cursor-zoom-in" onClick={() => setLightbox(true)}>
              <img src={img} alt={`Slim Wall ${i + 1}`} className="w-full h-auto object-contain" loading="lazy" />
            </div>
          ))}
        </div>
    ...
    {lightbox && <Lightbox images={IMAGES} initialIndex={index} name="Slim Wall" onClose={() => setLightbox(false)} />}
    </>
  )
}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
              ...
              <div>
                ...
                <h1 className="text-4xl font-extrabold text-white mb-2">Slim Wall</h1>
