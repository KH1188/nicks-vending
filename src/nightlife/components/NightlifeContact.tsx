...
const inputClass = (hasError: boolean) => `w-full px-4 py-2.5 text-sm rounded-lg border
  ${hasError ? 'border-red-400/60 bg-red-500/5' : 'border-ink-border bg-ink'}
  text-white placeholder-white/30
  focus:outline-none focus:ring-2 focus:ring-neon-violet focus:border-transparent
  transition-colors duration-200`

export default function NightlifeContact() {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-brand font-black text-white tracking-tight mb-5">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-ink-elevated border border-ink-border flex items-center justify-center text-neon-violet flex-shrink-0">
                ...
                <div>
                  ...
                  <a href="tel:+15042521125" className="text-sm font-medium text-white hover:text-neon-violet transition-colors">
                    504-252-1125
                  </a>
                  <p className="text-xs text-white/40 mt-0.5">Mon–Fri, 8 am – 5 pm</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:nicksvendingnola@gmail.com" className="text-sm font-medium text-white hover:text-neon-violet transition-colors">
                    nicksvendingnola@gmail.com
                  </a>
                  <p className="text-xs text-white/40 mt-0.5">We respond within 1 business day</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Right: form */}
          <div className="rounded-2xl border border-ink-border bg-ink-elevated p-8">
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-12 text-center gap-4">
                <div className="w-16 h-16 rounded-full bg-neon-violet/10 flex items-center justify-center">
                  <svg className="w-8 h-8 text-neon-violet" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <button onClick={() => setSubmit(false)} className="mt-2 text-sm text-white/50 hover:text-white transition-colors">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="name" className="block text-xs font-semibold text-white/60 mb-1.5">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="phone" className="block text-xs font-semibold text-white/60 mb-1.5">Phone</label>
                    <input id="phone" type="tel" placeholder="(555) 000-0000" {...field('phone')} />
                  </div>
                  <div>
                    <label htmlFor="business" className="block text-xs font-semibold text-white/60 mb-1.5">Venue Name</label>
                    <input id="business" type="text" placeholder="The Blue Room" {...field('business')} />
                  </div>
                </div>

                <div>
                  <label htmlFor="message" className="block text-xs font-semibold text-white/60 mb-1.5">
                ...
                <button
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-lg text-sm font-semibold
                    text-white bg-neon-gradient hover:shadow-neon active:scale-[0.98] transition-all duration-200 disabled:opacity-60"
                >
