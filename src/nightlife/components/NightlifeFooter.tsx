  ...
  return (
    <footer className="bg-ink-elevated border-t border-ink-border text-white/50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="pt-8 border-t border-ink-border flex flex-col items-center gap-6">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm font-semibold text-white/70 hover:text-neon-violet transition-colors"
          >
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/30">
